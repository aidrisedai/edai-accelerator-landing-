...
CREATE TABLE IF NOT EXISTS applications (
    ...
    teen_age INTEGER NOT NULL CHECK (teen_age >= 10 AND teen_age <= 18),
    teen_grade INTEGER NOT NULL CHECK (teen_grade >= 5 AND teen_grade <= 12),
...
COMMENT ON COLUMN applications.teen_age IS 'Teen age (10-18 years)';
COMMENT ON COLUMN applications.teen_grade IS 'Current grade (5-12)';
